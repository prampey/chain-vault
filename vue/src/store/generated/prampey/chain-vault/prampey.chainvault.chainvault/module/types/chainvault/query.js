...
const baseQueryGetCardsRequest = { id: 0 };
export const QueryGetCardsRequest = {
    ...
    decode(input, length) {
        const reader = input instanceof Uint8Array ? new Reader(input) : input;
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = { ...baseQueryGetCardsRequest };
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
...
const baseQueryGetCardsResponse = {};
export const QueryGetCardsResponse = {
    ...
    decode(input, length) {
        const reader = input instanceof Uint8Array ? new Reader(input) : input;
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = { ...baseQueryGetCardsResponse };
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
...
const baseQueryAllCardsRequest = {};
export const QueryAllCardsRequest = {
    ...
    decode(input, length) {
        const reader = input instanceof Uint8Array ? new Reader(input) : input;
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = { ...baseQueryAllCardsRequest };
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
...
const baseQueryAllCardsResponse = {};
export const QueryAllCardsResponse = {
    ...
    decode(input, length) {
        const reader = input instanceof Uint8Array ? new Reader(input) : input;
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = { ...baseQueryAllCardsResponse };
        message.Cards = [];
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
...
export class QueryClientImpl {
    ...
    Params(request) {
        ...
        const promise = this.rpc.request("prampey.chainvault.chainvault.Query", "Params", data);
        return promise.then((data) => QueryParamsResponse.decode(new Reader(data)));
    }
    Cards(request) {
        const data = QueryGetCardsRequest.encode(request).finish();
        const promise = this.rpc.request("prampey.chainvault.chainvault.Query", "Cards", data);
        return promise.then((data) => QueryGetCardsResponse.decode(new Reader(data)));
    }
    CardsAll(request) {
        const data = QueryAllCardsRequest.encode(request).finish();
        const promise = this.rpc.request("prampey.chainvault.chainvault.Query", "CardsAll", data);
        return promise.then((data) => QueryAllCardsResponse.decode(new Reader(data)));
    }
}
var globalThis = (() => {
