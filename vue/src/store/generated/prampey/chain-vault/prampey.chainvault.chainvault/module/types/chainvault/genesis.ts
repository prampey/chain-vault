...
const baseGenesisState: object = { cardsCount: 0 };
...
export const GenesisState = {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 2:
          ...
          break;
        case 3:
          message.cardsCount = longToNumber(reader.uint64() as Long);
          break;
        default:
  ...
  toJSON(message: GenesisState): unknown {
    ...
    if (message.cardsList) {
      obj.cardsList = message.cardsList.map((e) =>
        e ? Cards.toJSON(e) : undefined
      );
    } else {
      obj.cardsList = [];
    }
